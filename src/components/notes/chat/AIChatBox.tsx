...
import { BotIcon, LoaderIcon, SendIcon, XCircle } from "lucide-react";
                ...
                <div>
                    ...
                    >
                        ...
                        >
                            <span>
                                {isAnswering ? (
                                    <LoaderIcon className='h-5 w-5 text-foreground animate-spin' />
                                ) : (
        ...
        >
            <div className='flex items-center gap-2 w-fit text-lg text-primary font-bold'>
                {role === "user" ? (
                    ...
                    <BotIcon className='h-8 w-8 text-foreground' />
                )}
                {role === "user" ? "You" : "Bot"}
            </div>
            <div
...
const DefaultMessage = () => (
    <ChatMessage
        message={{
            role: "bot",
            content: "What the thing you want to know about your notes?",
        }}
    />
);
